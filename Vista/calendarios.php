        ...
        <div class="col-md-2 col-12">
            ...
            <div class="list-group" id="list-tab" role="tablist">
               <?php foreach ($param['calendarios_fechas'] as $key => $cal) { $fecha = $cal->getFecha(); ?>
                     <a class="list-group-item list-group-item-action <?= $key===0? 'active':'' ?> " id="list-<?= $fecha ?>-list" data-toggle="list" href="#list-<?= $fecha ?>" role="tab" aria-controls="home">
                    ...
                    <div class="col-md-10 col-12">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <?php foreach ($param['calendarios_fechas'] as $key => $cal) { $fecha = $cal->getFecha(); ?>
                                        <div class="tab-pane fade <?= $key===0? 'show active':'' ?>" id="list-<?= $fecha ?>" role="tabpanel" aria-labelledby="list-<?= $fecha ?>-list">
                                            <div class="row">
                                                                ...
                                                                <div class="col-md-auto col-12">
                                                                    <div class="card">
                                                                        <h3 class="card-header primary-color white-text text-center">
                                                                            <strong><?= $plaza->getPlaza()->getDescripcion() ?></strong>
                                                                        </h3>
                                                                        <div class="card-body">
